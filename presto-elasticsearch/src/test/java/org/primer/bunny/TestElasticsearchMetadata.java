...
import org.primer.bunny.util.TestTable;
...
import static org.primer.bunny.util.TestTable.TABLE_A_SCALAR;
import static org.primer.bunny.util.TestTable.TABLE_B_SCALAR;
import static org.primer.bunny.util.TestUtil.green;
import static org.primer.bunny.util.TestTable.TABLE_A_ARRAY;
import static org.primer.bunny.util.TestTable.TABLE_B_ARRAY;
...
public class TestElasticsearchMetadata
{
    ...
    public static void before() throws Exception
    {
        ...
        TABLE_A_ARRAY.create(client);
        TABLE_B_ARRAY.create(client);
    ...
    public void after()
    {
        try {
            ...
            TABLE_A_ARRAY.delete(client);
            TABLE_B_ARRAY.delete(client);
        }
        finally {
            if (client != null) {
                client.close();
    ...
    {
        return new Object[][] { { TABLE_A_ARRAY, ARRAY_SESSION }, { TABLE_A_SCALAR, SCALAR_SESSION } };
    }
    ...
    {
        return new Object[][] {
                { TABLE_A_ARRAY, TABLE_B_ARRAY, TABLE_A_SCALAR, TABLE_B_SCALAR, SESSION } };
    }
