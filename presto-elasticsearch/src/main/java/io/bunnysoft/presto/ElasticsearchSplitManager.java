...
public class ElasticsearchSplitManager implements ConnectorSplitManager
{
    ...
    {
        ElasticsearchTableLayoutHandle handle = Types.checkType(layout, ElasticsearchTableLayoutHandle.class, "layout");
    ...
    {
        return tupleDomain.transform(handle -> Types.checkType(handle, ElasticsearchColumnHandle.class, "columnHandle"));
    }
