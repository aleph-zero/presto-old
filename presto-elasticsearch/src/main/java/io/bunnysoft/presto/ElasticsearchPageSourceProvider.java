...
public class ElasticsearchPageSourceProvider implements ConnectorPageSourceProvider
{
    ...
    {
        ElasticsearchSplit split = Types.checkType(connectorSplit, ElasticsearchSplit.class, "split");

        ImmutableList.Builder<ElasticsearchColumnHandle> handles = ImmutableList.builder();
        for (ColumnHandle column : columns) {
            handles.add(Types.checkType(column, ElasticsearchColumnHandle.class, "columnHandle"));
        }
